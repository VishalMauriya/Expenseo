...
<body>
  ...
  <li style="float:right"><a class="active" href="home.jsp">Home</a></li>
    ...
    <!-- Header -->
    <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 350px; background-image: url(); background-color: grey; background-size: cover; background-position: center top;">
      <!-- Mask -->
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                    <image class="rounded-circle" src="images/avator.png"/>
             </div>
              </div>
            </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="UserID" value="<%=user._id%>">
                      </div>
                    </div>
                    <div class="col-lg-6">
